...
const InstructorSortSelectOption: FC<Props> = ({ sortOption, onSortChange }) => {
  const sortObjectLibrary = {
    all: { key: 'all', order: 'none' },
    name: { key: 'fullName', order: 'descending' },
    newest: { key: 'registerDate', order: 'descending' },
    oldest: { key: 'registerDate', order: 'ascending' },
    MostStudent: { key: 'students', order: 'descending' },
    LeastStudent: { key: 'students', order: 'ascending' },
  }

  const sortOptions = [
    { text: 'همه', value: 'all' },
    { text: 'بر اساس نام', value: 'name' },
    { text: 'جدید ترین', value: 'newest' },
    { text: 'قدیمی ترین', value: 'oldest' },
    { text: 'بیشترین دانشجو', value: 'MostStudent' },
    { text: 'کم ترین دانشجو', value: 'LeastStudent' },
  ]
...
export { InstructorSortSelectOption }
